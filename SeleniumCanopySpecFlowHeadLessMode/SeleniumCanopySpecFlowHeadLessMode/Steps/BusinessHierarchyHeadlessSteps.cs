...
namespace SeleniumCanopySpecFlowHeadLessMode.Steps
{
    [Binding]
    public class BusinessHierarchyHeadlessSteps
    {

        // Other available headless mode drivers
        // Headless Chrome
        // PhantomJS
        // SlimerJS
        // TrifleJS
        ...
        {   // Initial Set up
            ...
            // Opening Browser
            _.start(types.BrowserStartMode.ChromeHeadless);
